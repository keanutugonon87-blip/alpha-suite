...
import { setupHTML, attachSetupEvents, gateHTML, attachGateEvents, publicHTML, attachPublicEvents, appHTML, attachAppEvents, renderModal, runCountUps } from './screens.js?v=3';
...
export function render(){
  ...
  if(MAINTENANCE_MODE){
    root.innerHTML = `<div class="loading">
      ...
      <span style="font-family:'Cinzel',serif;font-weight:700;font-size:2rem;letter-spacing:.05em;">ALPHA WATCH</span>
